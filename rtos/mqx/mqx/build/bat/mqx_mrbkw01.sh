...
cp -f "${ROOTDIR}/config/mcu/MKW01Z4/mqx_sdk_config.h" "${OUTPUTDIR}/../config/mqx_sdk_config.h"
cp -f "${ROOTDIR}/config/board/mrbkw01/user_config.h" "${OUTPUTDIR}/../config/user_config.h"
