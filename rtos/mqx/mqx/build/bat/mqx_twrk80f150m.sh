...
cp -f "${ROOTDIR}/config/mcu/MK80F25615/mqx_sdk_config.h" "${OUTPUTDIR}/../config/mqx_sdk_config.h"
cp -f "${ROOTDIR}/config/board/twrk80f150m/user_config.h" "${OUTPUTDIR}/../config/user_config.h"
