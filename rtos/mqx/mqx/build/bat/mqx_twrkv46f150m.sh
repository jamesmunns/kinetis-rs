...
cp -f "${ROOTDIR}/config/mcu/MKV46F15/mqx_sdk_config.h" "${OUTPUTDIR}/../config/mqx_sdk_config.h"
cp -f "${ROOTDIR}/config/board/twrkv46f150m/user_config.h" "${OUTPUTDIR}/../config/user_config.h"
