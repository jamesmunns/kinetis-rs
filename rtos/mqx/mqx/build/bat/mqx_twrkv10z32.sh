...
cp -f "${ROOTDIR}/config/mcu/MKV10Z7/mqx_sdk_config.h" "${OUTPUTDIR}/../config/mqx_sdk_config.h"
cp -f "${ROOTDIR}/config/board/twrkv10z32/user_config.h" "${OUTPUTDIR}/../config/user_config.h"
