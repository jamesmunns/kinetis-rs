#!/usr/bin/env bash
(cd  ../../../../../build/armgcc/mqx_usbkw40z_kw40z && source build_release.sh nopause) 
(cd  ../../../../../../mqx_stdlib/build/armgcc/mqx_stdlib_usbkw40z_kw40z && source build_release.sh nopause) 
