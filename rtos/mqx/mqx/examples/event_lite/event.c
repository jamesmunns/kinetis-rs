...
#if MQX_USE_EVENTS == 0
    #error "MQX_USE_EVENTS must be set to non-zero in mqx_sdk_config.h for this demo."
#endif

#if MQX_USE_NAME == 0
    #error "MQX_USE_NAME must be set to non-zero in mqx_sdk_config.h for this demo."
#endif
...
#define ISR_TASK_STACK_SIZE       MQX_REQUIRED_STACK_SIZE(2000)
