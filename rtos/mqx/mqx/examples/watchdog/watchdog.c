...
const TASK_TEMPLATE_STRUCT  MQX_template_list[] =
{
   /* Task Index, Function,   Stack, Priority,  Name,       Attributes,          Param, Time Slice */
    { MAIN_TASK,  main_task,  1600,  8,         "Main",     MQX_AUTO_START_TASK, 0,     0 },
    { TEST_TASK,  test_task,  1600,  9,         "Test",     0,                   0,     0 },
    { 0 }
};
   ...
   )
{
  _task_id test_task;
   ...
   assert (test_task != MQX_NULL_TASK_ID); /* Task create failed probably because of lack of memory resources */
