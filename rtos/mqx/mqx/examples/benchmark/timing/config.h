...
/* Define the BSP being used*/
    ...
    /* K64F120 board is used for testing */
    #ifdef K64F12_SERIES
        #define tBOARD          "Freescale TWRK64F120"
        #define tCPU            "MK64F120M"
        #define tMEMORY         "N/A Internal RAM"
    #endif
    ...
    #define SYSTEM_CLOCK           (DEFAULT_SYSTEM_CLOCK / 1000000)       /* system bus frequency in MHz */
